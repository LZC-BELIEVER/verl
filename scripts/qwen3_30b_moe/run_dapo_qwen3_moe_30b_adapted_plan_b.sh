...
exp_name="DAPO-Qwen3-MOE-30B-VLLM-FP8-ROLLOUT-PLAN-B-${TIMESTAMP}"
...
# ============================================================================
# Batch Size 配置 - 方案 B（激进，用于 OOM 情况）
# ============================================================================
# 方案 B（1节点×4GPU=4GPU）:
#   总样本数: 8×8=64 (16 samples/GPU)
#   预期显存: ~60-80GB/GPU
train_prompt_bsz=8
n_resp_per_prompt=8
...
# 性能和并行配置 - 方案 B（激进）
# ============================================================================
# 方案 B: sp_size=1（禁用序列并行）, gen_tp=4（使用全部4个GPU推理）
sp_size=1
gen_tp=4
train_tp=1
train_pp=1
