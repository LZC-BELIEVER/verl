#!/usr/bin/env bash
# ============================================================
# OOL Speed Benchmark: FP8 Training + FP8 Linear (no FP8 KV cache)
# Training: Megatron FP8 hybrid (blockwise)
# Rollout:  vLLM FP8 linear weights, KV cache stays BF16
# ============================================================

TIMESTAMP=$(date +%Y-%m-%d-%H-%M-%S)
EXP_NAME="ool-fp8-train-linear-1.7b-${TIMESTAMP}"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/lanzichang1/models/Qwen3-1.7B-Base \
    ...
    trainer.project_name='speed-benchmark-ool-1.7b' \
    trainer.experiment_name=$EXP_NAME \
    trainer.total_epochs=10 \
    trainer.total_training_steps=1000 2>&1 | tee $OUTPUT_DIR/verl_result.log
