#!/usr/bin/env bash
# ============================================================
# Experiment: FP8 Rollout + QAT (Quantization-Aware Training)
# Training:   Megatron BF16 + FP8 W8A8 fake-quant (STE hooks)
# Rollout:    vLLM FP8
# IS:         disabled
# Note:       fake-quant matches vLLM rollout.quantization=fp8 exactly
# ============================================================

TIMESTAMP=$(date +%Y-%m-%d-%H-%M-%S)
EXP_NAME="accuracy-fp8-qat-8b-${TIMESTAMP}"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.megatron.qat.mode=w8a8 \
