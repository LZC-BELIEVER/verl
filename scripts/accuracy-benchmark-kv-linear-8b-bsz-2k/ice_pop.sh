#!/usr/bin/env bash
# ============================================================
# Experiment: FP8 Rollout + IcePop (Token-level IS with hard trust region)
# Training:   Megatron BF16
# Rollout:    vLLM FP8
# IS:         token-level, IcePop zeroing weights outside [0.5, 2.0]
# ============================================================

TIMESTAMP=$(date +%Y-%m-%d-%H-%M-%S)
EXP_NAME="accuracy-fp8-icepop-8b-${TIMESTAMP}"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    algorithm.rollout_correction.rollout_is_threshold=-_2.0 \
