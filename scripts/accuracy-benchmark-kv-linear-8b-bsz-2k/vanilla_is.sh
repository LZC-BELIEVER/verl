#!/usr/bin/env bash
# ============================================================
# Experiment: FP8 Rollout + Vanilla IS (no truncation)
# Training:   Megatron BF16
# Rollout:    vLLM FP8
# IS:         token-level, no truncation (threshold=1e9)
# ============================================================

TIMESTAMP=$(date +%Y-%m-%d-%H-%M-%S)
EXP_NAME="accuracy-fp8-vanilla-is-8b-${TIMESTAMP}"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    algorithm.rollout_correction.rollout_is_threshold=1e9 \
