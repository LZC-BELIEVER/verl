#!/usr/bin/env bash
# ============================================================
# Experiment: FP8 End-to-End (FP8 Training + FP8 Rollout)
# Training:   Megatron FP8 (hybrid, blockwise)
# Rollout:    vLLM FP8
# IS:         disabled
# Note:       requires CUDA 12.9+ and NVTE_FP8_BLOCK_SCALING_FP32_SCALES=1
# ============================================================

TIMESTAMP=$(date +%Y-%m-%d-%H-%M-%S)
EXP_NAME="accuracy-fp8-e2e-8b-${TIMESTAMP}"
...
export NVTE_FP8_BLOCK_SCALING_FP32_SCALES=1  # required for blockwise FP8 training
