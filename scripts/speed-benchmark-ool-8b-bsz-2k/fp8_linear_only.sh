#!/usr/bin/env bash
# ============================================================
# OOL Speed Benchmark: Linear FP8 Only
# Training: Megatron BF16 (no fp8)
# Rollout:  vLLM FP8 linear weights + BF16 KV cache
# ============================================================

TIMESTAMP=$(date +%Y-%m-%d-%H-%M-%S)
EXP_NAME="ool-fp8-linear-only-8b-${TIMESTAMP}"
