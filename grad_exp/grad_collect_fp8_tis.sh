#!/usr/bin/env bash
# ============================================================
# Gradient collection (FP8 vLLM rollout + TIS): no optimizer step.
# Samples 20 batches of 32 prompts each, dumps per-batch grads to
#   /lanzichang1/new_verl/grads/fp8/batch_XXXX/rank_YYYY.pt
# ============================================================
ray stop --force || true
pkill -9 ray || true
pkill -9 python || true
...
GRAD_DIR="/lanzichang1/new_verl/grads/fp8_tis"
mkdir -p $OUTPUT_DIR
mkdir -p $GRAD_DIR
