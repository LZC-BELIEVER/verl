#!/usr/bin/env bash
# ============================================================
# Gradient collection (FP8 vLLM rollout + TIS): save raw gradient from first batch
# ============================================================
ray stop --force || true
pkill -9 ray || true
pkill -9 python || true
...
EXP_NAME="grad_collect-fp8_tis-raw-${TIMESTAMP}"
OUTPUT_DIR="/lanzichang1/new_verl/checkpoints/$EXP_NAME"
GRAD_DIR="/lanzichang1/new_verl/grads/ori_grad/fp8_tis"
mkdir -p $OUTPUT_DIR
mkdir -p $GRAD_DIR
...
# ---- Rollout Correction (TIS, matches fp8 training) ----
rollout_is=token
