#!/usr/bin/env bash
# ============================================================
# Gradient collection (bf16 rollout): save raw gradient from first batch
# ============================================================
ray stop --force || true
pkill -9 ray || true
pkill -9 python || true
...
EXP_NAME="grad_collect-bf16-raw-${TIMESTAMP}"
OUTPUT_DIR="/lanzichang1/new_verl/checkpoints/$EXP_NAME"
GRAD_DIR="/lanzichang1/new_verl/grads/ori_grad/bf16"
mkdir -p $OUTPUT_DIR
mkdir -p $GRAD_DIR
