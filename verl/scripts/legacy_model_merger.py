...
"""
This script is used to merge huggingface model and test verl checkpoints-speed-8b-ool from FSDP and Megatron backends.

To merge FSDP checkpoints-speed-8b-ool:
```sh
python scripts/legacy_model_merger.py merge \
    --backend fsdp \
    --local_dir checkpoints-speed-8b-ool/verl_fsdp_gsm8k_examples/qwen2_5_0b5_fsdp_saveload/global_step_1/actor \
    --target_dir /path/to/merged_hf_model
```

To merge Megatron checkpoints-speed-8b-ool:
```sh
python scripts/legacy_model_merger.py merge \
    --backend megatron \
    --tie-word-embedding \
    --local_dir checkpoints-speed-8b-ool/verl_megatron_gsm8k_examples/qwen2_5_0b5_megatron_saveload/global_step_1/actor \
    --target_dir /path/to/merged_hf_model
```
...
def main():
    ...
    base_op_parser.add_argument("--local_dir", type=str, required=True, help="Path to the saved model checkpoints-speed-8b-ool")
    base_op_parser.add_argument(
        "--hf_model_path",
        type=str,
        default=None,
