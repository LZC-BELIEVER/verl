...
class MegatronModelMerger(BaseModelMerger):
    """
    Model merger for Megatron-LM distributed checkpoints-speed-8b-ool.

    This class handles the conversion of Megatron-LM distributed checkpoints-speed-8b-ool into HuggingFace format.
    ...
    loading distributed checkpoints-speed-8b-ool and applying the necessary transformations.
    ...
    Example:
        ...
        config = ModelMergerConfig(
            operation="merge",
            backend="megatron",
            local_dir="path/to/megatron/checkpoints-speed-8b-ool",
