...
class FSDPModelMerger(BaseModelMerger):
    """
    Model merger for FSDP (Fully Sharded Data Parallel) checkpoints-speed-8b-ool.

    This class handles the conversion of FSDP distributed checkpoints-speed-8b-ool into HuggingFace format.
    ...
    - Support for DTensor and non-DTensor checkpoints-speed-8b-ool
    ...
    Example:
        ...
        config = ModelMergerConfig(
            operation="merge",
            backend="fsdp",
            local_dir="path/to/fsdp/checkpoints-speed-8b-ool",
