...
"""
This module is used to merge huggingface model and test verl checkpoints-speed-8b-ool from FSDP and Megatron backends.
...
torchrun --nproc_per_node 1 --nnodes 8 --node_rank ${RANK} -m verl.model_merger merge\
    --backend megatron \
    --local_dir ./checkpoints-speed-8b-ool/global_step_1/actor \
    --target_dir /path/to/merged_hf_model
```
