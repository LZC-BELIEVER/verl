...
class CheckpointConfig(BaseConfig):
    ...
    Args:
        save_contents (list[str]): What to include in saved checkpoints-speed-8b-ool.
        ...
        async_save (bool): Whether to save checkpoints-speed-8b-ool asynchronously. Only implemented for Megatron as of now.
    """
