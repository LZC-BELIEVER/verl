...
__all__ = ["FSDPEngineConfig", "McoreEngineConfig", "TrainingWorkerConfig", "QATEngineConfig"]
...
class QATEngineConfig(BaseConfig):
    ...
    Args:
        ...
        mode (str): Quantization mode, "w4a16", "w4a4", or "w8a8", default "w4a16".
            "w8a8" uses FP8 blockwise fake-quantization (weights + activations) via STE hooks,
            matching the exact quantization scheme of vLLM rollout.quantization=fp8.
