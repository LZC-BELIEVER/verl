...
python3 -m verl.model_merger merge \
    --backend fsdp \
    --local_dir checkpoints-speed-8b-ool/verl_grpo_example_gsm8k/${EXP_NAME}/global_step_1/actor/ \
    --target_dir checkpoints-speed-8b-ool/verl_grpo_example_gsm8k/${EXP_NAME}/global_step_1/actor/hf
